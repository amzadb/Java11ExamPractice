...
public class String1 {
	...
	public static void StringLiterals() {
		...
		String s2 = "hello";
		System.out.println("s1 and s2 are string literals assigned to String variables: (s1 == s2) = " + (s1 == s2));
	...
	public static void StringConstructors() {
		...
		System.out.println(
				"s1 and s2 are constructed String objects assigned to String variables: (s1 == s2) = " + (s1 == s2));
	}
	...
	public static void StringConstructorsInterned() {
		...
		System.out.println(
				"s1 and s2 are interned String objects assigned to String variables: (s1 == s2) = " + (s1 == s2));
	}
}