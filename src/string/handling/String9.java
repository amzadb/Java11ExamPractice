...
public class String9 {
	...
	public static void main(String[] args) {
		...
		// Returns a String
		resultArray[3] = "Replace first match of regexp [i with 2 characters(s or p)] " + "with literal \"ax\" : "
		...
		System.out.println("mississippi.substring(3, 7) = " + mississippi.substring(3, 7)); // start index = 3, end
																							// index = 7
