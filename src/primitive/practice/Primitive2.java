...
public class Primitive2 {
	public static void main(String[] args) {
		...
		// You can set all of the numeric primitive data variables
		// to a literal number from 0 to 127.
		byte b = 127;
		char c = 127;
		short s = 127;
		int i = 127;
...
//		byte b8=0b_ 00000001; // Cannot have underscore directly after 0b
//		char c8=0x_ 007F; // Cannot have underscore directly after 0x
//		int i8=1000000_; // Underscore cannot be at end of literal
//		long d8=1000000_ L; // Underscore cannot be prior to suffix (L/l,F/f,D/d)
//		float f8=_1000.000000; // Underscore cannot be at start of literal
//		double l8=1.0000000_ e10; // Underscore cannot prefix exponential in literal
